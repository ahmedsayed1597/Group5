...
public class Product  implements java.io.Serializable {
    ...
    public Product(int id, Category category, String name, String description, int price, int quantity, String imageUrl) {
        this.id = id;
    ...
    public Product(int id, Category category, String name, String description, int price, int quantity, String imageUrl, Set<UserReviewProduct> userReviewProducts, Set<OrderProducts> orderProductses) {
       this.id = id;
       this.category = category;
       this.name = name;
       this.description = description;
